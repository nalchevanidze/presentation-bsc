...
\begin{itemize}
    ...
    \li{Support directives} Since the GraphQL specification does not specify a particular implementation strategy for directives~\cite{schema-directives}.
    % it is up to each server library to provide a suitable API
