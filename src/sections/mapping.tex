...
\begin{itemize}
  ...
  That why we assume that a constructor without field selectors is enumerated like an array in the GraphQL context. 
  ...
  Therefore, we introduce it as an enum type \expr{Unit} containing only an alternative \expr{Unit}. 
